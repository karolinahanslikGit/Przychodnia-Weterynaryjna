...
public class LogInActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private void UserLoggedIn(String email) {
        ...
        // 000000000000000000000 Tutaj zie zmiania to w firebase
        ...
        FirebaseDatabase.getInstance().getReference("Lekarze:").child("Lek: "+name).setValue(new Person(name)).addOnCompleteListener(new OnCompleteListener<Void>() {
            // FirebaseDatabase.getInstance().getReference("Lekarze:").child("Lek: "+name).setValue(new Person(name,firebaseAuth.getCurrentUser().getUid())).addOnCompleteListener(new OnCompleteListener<Void>() {
